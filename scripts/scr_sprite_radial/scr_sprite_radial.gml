/// @description scr_spite_radial(Invert, Dissolve Speed, Chunk Size, Shrink, Shrink amt, Gravity, Fade, Fade amt, Spin, Life);
/// @param Invert
...
/// @param  Spin
/// @param  Life
function scr_sprite_radial(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
